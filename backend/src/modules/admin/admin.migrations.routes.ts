// src/modules/admin/admin.migrations.routes.ts
import type { FastifyInstance } from 'fastify'
import prisma from '../../lib/prisma'

export default async function adminMigrationsRoutes(app: FastifyInstance) {
  app.get('/admin/migrations', {
    ...
    try {
      ...
      return (reply as any).code(500).send({ error: 'Failed to query migrations', message: e?.message || String(e) })
    }
  })
}
