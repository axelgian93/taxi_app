// scripts/smoke-admin-trips-report.ts
...
async function main() {
  console.log('Smoke Admin Trips Report @', BASE)
  await check('/admin/trips/report?groupBy=city')
  await check('/admin/trips/report?groupBy=status')
}
