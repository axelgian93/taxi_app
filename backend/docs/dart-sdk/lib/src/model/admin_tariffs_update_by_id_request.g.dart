...
part of 'admin_tariffs_update_by_id_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AdminTariffsUpdateByIdRequest extends AdminTariffsUpdateByIdRequest {
  @override
  final String? city;
  @override
  final bool? active;
  ...
  factory _$AdminTariffsUpdateByIdRequest(
          [void Function(AdminTariffsUpdateByIdRequestBuilder)? updates]) =>
      (AdminTariffsUpdateByIdRequestBuilder()..update(updates))._build();

  _$AdminTariffsUpdateByIdRequest._(
      {this.city,
      this.active,
      this.baseFareUsd,
      this.perKmUsd,
      ...
      : super._();
  @override
  AdminTariffsUpdateByIdRequest rebuild(
          void Function(AdminTariffsUpdateByIdRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AdminTariffsUpdateByIdRequestBuilder toBuilder() =>
      AdminTariffsUpdateByIdRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AdminTariffsUpdateByIdRequest &&
        city == other.city &&
        active == other.active &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AdminTariffsUpdateByIdRequest')
          ..add('city', city)
          ..add('active', active)
...
class AdminTariffsUpdateByIdRequestBuilder
    implements
        Builder<AdminTariffsUpdateByIdRequest,
            AdminTariffsUpdateByIdRequestBuilder> {
  _$AdminTariffsUpdateByIdRequest? _$v;
  ...
  AdminTariffsUpdateByIdRequestBuilder() {
    AdminTariffsUpdateByIdRequest._defaults(this);
  }

  AdminTariffsUpdateByIdRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _city = $v.city;
      _active = $v.active;
  ...
  @override
  void replace(AdminTariffsUpdateByIdRequest other) {
    _$v = other as _$AdminTariffsUpdateByIdRequest;
  }

  @override
  void update(void Function(AdminTariffsUpdateByIdRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AdminTariffsUpdateByIdRequest build() => _build();

  _$AdminTariffsUpdateByIdRequest _build() {
    final _$result = _$v ??
        _$AdminTariffsUpdateByIdRequest._(
          city: city,
          active: active,
