...
part 'admin_tariffs_get200_response_items_inner.g.dart';

/// AdminTariffsGet200ResponseItemsInner
///
/// Properties:
/// * [id] 
/// * [city] 
...
/// * [updatedAt] 
@BuiltValue()
abstract class AdminTariffsGet200ResponseItemsInner implements Built<AdminTariffsGet200ResponseItemsInner, AdminTariffsGet200ResponseItemsInnerBuilder> {
  ...
  AdminTariffsGet200ResponseItemsInner._();

  factory AdminTariffsGet200ResponseItemsInner([void updates(AdminTariffsGet200ResponseItemsInnerBuilder b)]) = _$AdminTariffsGet200ResponseItemsInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminTariffsGet200ResponseItemsInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminTariffsGet200ResponseItemsInner> get serializer => _$AdminTariffsGet200ResponseItemsInnerSerializer();
}

class _$AdminTariffsGet200ResponseItemsInnerSerializer implements PrimitiveSerializer<AdminTariffsGet200ResponseItemsInner> {
  @override
  final Iterable<Type> types = const [AdminTariffsGet200ResponseItemsInner, _$AdminTariffsGet200ResponseItemsInner];

  @override
  final String wireName = r'AdminTariffsGet200ResponseItemsInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AdminTariffsGet200ResponseItemsInner object, {
  ...
  void _deserializeProperties(
    ...
    required AdminTariffsGet200ResponseItemsInnerBuilder result,
  ...
  @override
  AdminTariffsGet200ResponseItemsInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AdminTariffsGet200ResponseItemsInnerBuilder();
