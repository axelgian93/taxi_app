...
part 'admin_tariffs_post_request.g.dart';

/// AdminTariffsPostRequest
///
/// Properties:
/// * [city] 
/// * [active] 
...
@BuiltValue()
abstract class AdminTariffsPostRequest implements Built<AdminTariffsPostRequest, AdminTariffsPostRequestBuilder> {
  ...
  AdminTariffsPostRequest._();

  factory AdminTariffsPostRequest([void updates(AdminTariffsPostRequestBuilder b)]) = _$AdminTariffsPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminTariffsPostRequestBuilder b) => b
      ..active = true
      ..nightMultiplier = 1
      ..weekendMultiplier = 1
      ..surgeMultiplier = 1
  ...
  static Serializer<AdminTariffsPostRequest> get serializer => _$AdminTariffsPostRequestSerializer();
}

class _$AdminTariffsPostRequestSerializer implements PrimitiveSerializer<AdminTariffsPostRequest> {
  @override
  final Iterable<Type> types = const [AdminTariffsPostRequest, _$AdminTariffsPostRequest];

  @override
  final String wireName = r'AdminTariffsPostRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AdminTariffsPostRequest object, {
  ...
  void _deserializeProperties(
    ...
    required AdminTariffsPostRequestBuilder result,
  ...
  @override
  AdminTariffsPostRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AdminTariffsPostRequestBuilder();
