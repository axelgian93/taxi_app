...
part 'admin_tariffs_id_patch_request.g.dart';
...
@BuiltValue()
abstract class AdminTariffsIdPatchRequest implements Built<AdminTariffsIdPatchRequest, AdminTariffsIdPatchRequestBuilder> {
  ...
  AdminTariffsIdPatchRequest._();

  factory AdminTariffsIdPatchRequest([void updates(AdminTariffsIdPatchRequestBuilder b)]) = _$AdminTariffsIdPatchRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminTariffsIdPatchRequestBuilder b) => b
      ..active = true
      ..nightMultiplier = 1
      ..weekendMultiplier = 1
      ..surgeMultiplier = 1
  ...
  static Serializer<AdminTariffsIdPatchRequest> get serializer => _$AdminTariffsIdPatchRequestSerializer();
}

class _$AdminTariffsIdPatchRequestSerializer implements PrimitiveSerializer<AdminTariffsIdPatchRequest> {
  @override
  final Iterable<Type> types = const [AdminTariffsIdPatchRequest, _$AdminTariffsIdPatchRequest];

  @override
  final String wireName = r'AdminTariffsIdPatchRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AdminTariffsIdPatchRequest object, {
  ...
  void _deserializeProperties(
    ...
    required AdminTariffsIdPatchRequestBuilder result,
  ...
  @override
  AdminTariffsIdPatchRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AdminTariffsIdPatchRequestBuilder();
