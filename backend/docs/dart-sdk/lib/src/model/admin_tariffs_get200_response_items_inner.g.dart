...
part of 'admin_tariffs_get200_response_items_inner.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AdminTariffsGet200ResponseItemsInner
    extends AdminTariffsGet200ResponseItemsInner {
  @override
  final String? id;
  @override
  final String? city;
  ...
  factory _$AdminTariffsGet200ResponseItemsInner(
          [void Function(AdminTariffsGet200ResponseItemsInnerBuilder)?
              updates]) =>
      (AdminTariffsGet200ResponseItemsInnerBuilder()..update(updates))._build();

  _$AdminTariffsGet200ResponseItemsInner._(
      {this.id,
      this.city,
      this.active,
      this.baseFareUsd,
      ...
      : super._();
  @override
  AdminTariffsGet200ResponseItemsInner rebuild(
          void Function(AdminTariffsGet200ResponseItemsInnerBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AdminTariffsGet200ResponseItemsInnerBuilder toBuilder() =>
      AdminTariffsGet200ResponseItemsInnerBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AdminTariffsGet200ResponseItemsInner &&
        id == other.id &&
        city == other.city &&
        active == other.active &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AdminTariffsGet200ResponseItemsInner')
          ..add('id', id)
          ..add('city', city)
          ..add('active', active)
...
class AdminTariffsGet200ResponseItemsInnerBuilder
    implements
        Builder<AdminTariffsGet200ResponseItemsInner,
            AdminTariffsGet200ResponseItemsInnerBuilder> {
  _$AdminTariffsGet200ResponseItemsInner? _$v;
  ...
  AdminTariffsGet200ResponseItemsInnerBuilder() {
    AdminTariffsGet200ResponseItemsInner._defaults(this);
  }

  AdminTariffsGet200ResponseItemsInnerBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _city = $v.city;
  ...
  @override
  void replace(AdminTariffsGet200ResponseItemsInner other) {
    _$v = other as _$AdminTariffsGet200ResponseItemsInner;
  }
  ...
  @override
  AdminTariffsGet200ResponseItemsInner build() => _build();

  _$AdminTariffsGet200ResponseItemsInner _build() {
    final _$result = _$v ??
        _$AdminTariffsGet200ResponseItemsInner._(
          id: id,
          city: city,
