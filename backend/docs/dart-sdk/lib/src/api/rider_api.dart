...
class RiderApi {
  ...
  const RiderApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RiderMyTrips200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RiderMyTrips200Response>> riderMyTrips({ 
    int? limit = 20,
    String? cursor,
    ...
    RiderMyTrips200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RiderMyTrips200Response),
      ) as RiderMyTrips200Response;
    ...
    return Response<RiderMyTrips200Response>(
      data: _responseData,
