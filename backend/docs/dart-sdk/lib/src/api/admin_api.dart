...
class AdminApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AdminDiagnosticsMatching200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminDiagnosticsMatching200Response>> adminDiagnosticsMatching({ 
    ...
    final _path = r'/admin/diagnostics/matching';
    ...
    AdminDiagnosticsMatching200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminDiagnosticsMatching200Response),
      ) as AdminDiagnosticsMatching200Response;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> adminMetrics({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminTariffsList200ResponseItemsInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminTariffsList200ResponseItemsInner>> adminTariffsCreate({ 
    required AdminTariffsCreateRequest adminTariffsCreateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AdminTariffsCreateRequest);
      _bodyData = _serializers.serialize(adminTariffsCreateRequest, specifiedType: _type);
    ...
    AdminTariffsList200ResponseItemsInner? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminTariffsList200ResponseItemsInner),
      ) as AdminTariffsList200ResponseItemsInner;
    ...
    return Response<AdminTariffsList200ResponseItemsInner>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminTariffsList200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminTariffsList200Response>> adminTariffsList({ 
    String? city,
    bool? active,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    AdminTariffsList200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminTariffsList200Response),
      ) as AdminTariffsList200Response;
    ...
    return Response<AdminTariffsList200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [AdminTariffsList200ResponseItemsInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminTariffsList200ResponseItemsInner>> adminTariffsUpdateById({ 
    required String id,
    ...
    final _path = r'/admin/tariffs/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AdminTariffsUpdateByIdRequest);
      _bodyData = adminTariffsUpdateByIdRequest == null ? null : _serializers.serialize(adminTariffsUpdateByIdRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminTripsList200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminTripsList200Response>> adminTripsList({ 
    int? limit = 50,
    String? cursor,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    AdminTripsList200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminTripsList200Response),
      ) as AdminTripsList200Response;
    ...
    return Response<AdminTripsList200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> metricsPublic({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
