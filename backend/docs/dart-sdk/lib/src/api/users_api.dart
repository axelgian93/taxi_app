...
class UsersApi {
  ...
  Future<Response<DriverUpdateStatus200Response>> usersDeletePushToken({ 
    ...
    final _path = r'/users/me/push-token';
  ...
  Future<Response<DriverUpdateStatus200Response>> usersRegisterPushToken({ 
    ...
    try {
      const _type = FullType(UsersRegisterPushTokenRequest);
      _bodyData = _serializers.serialize(usersRegisterPushTokenRequest, specifiedType: _type);
