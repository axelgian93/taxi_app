...
class DriversApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [DriverMyTripsActive200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DriverMyTripsActive200Response>> driverMyTripsActive({ 
    ...
    final _path = r'/drivers/my-trips/active';
    ...
    DriverMyTripsActive200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DriverMyTripsActive200Response),
      ) as DriverMyTripsActive200Response;
    ...
    return Response<DriverMyTripsActive200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DriverMyTripsHistory200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DriverMyTripsHistory200Response>> driverMyTripsHistory({ 
    int? limit = 20,
    String? cursor,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/drivers/my-trips/history';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DriverMyTripsHistory200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DriverMyTripsHistory200Response),
      ) as DriverMyTripsHistory200Response;
    ...
    return Response<DriverMyTripsHistory200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DriverUpdateStatus200Response>> driverUpdateLocation({ 
    ...
    try {
      const _type = FullType(DriverUpdateStatusRequest);
      _bodyData = driverUpdateStatusRequest == null ? null : _serializers.serialize(driverUpdateStatusRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [DriverUpdateStatus200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DriverUpdateStatus200Response>> driverUpdateStatus({ 
    DriverUpdateStatusRequest? driverUpdateStatusRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
