...
class AuthApi {
  ...
  Future<Response<AuthRefresh200Response>> authRefresh({ 
    required AuthRefreshRequest authRefreshRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AuthRefreshRequest);
      _bodyData = _serializers.serialize(authRefreshRequest, specifiedType: _type);
